...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::beginTransaction();
            $product_details['product_scope'] = $request->input('product_scope');
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $product->product_scope = $request->input('product_scope');
