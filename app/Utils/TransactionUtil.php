...
class TransactionUtil extends Util
{
    ...
    public function getInvoiceNumber($business_id, $status, $location_id, $invoice_scheme_id = null, $sale_type = null)
    {
        if ($status == 'final') {
            ...
            return $invoice_no;
        }elseif ($status == 'gate_outward') {
 
            $ref_count = $this->setAndGetReferenceCount('gate_outward', $business_id);
            $invoice_no = 'gt_out'.$this->generateReferenceNumber('gate_outward', $ref_count, $business_id);
            return $invoice_no;
        }
