			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						{!! Form::select('income_category_id', $income_categories, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::text('payment_date', @format_datetime('now'), ['class' => 'form-control paid_on', 'readonly', 'required']); !!}
						</div>
					</div>
				</div>
			    ...
			    <div class="col-sm-4">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::select('payment_method', $payment_types, 'cash', ['class' => 'form-control select2', 'required']); !!}
						</div>
					</div>
				</div>
				...
				<div class="col-sm-12">
					<div class="form-group">
						...
						{!! Form::textarea('additional_notes', null, ['class' => 'form-control', 'rows' => 3, 'placeholder' => __('income.narration')]); !!}
					</div>
				</div>
			</div>
		</div>
