...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 @if(!session('business.enable_category')) hide @endif">
            <div class="form-group">
                {!! Form::label('product_scope', 'Product Type' . ':') !!}
                {!! Form::select('product_scope', [
                    'raw_material' => __('Raw Material'),
                    'finished_goods' => __('Finished Goods'),
                    'packing_type' => __('Packing'),
                ], !empty($duplicate_product->product_scope) ? $duplicate_product->product_scope : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']) !!}
            </div>
        </div>
