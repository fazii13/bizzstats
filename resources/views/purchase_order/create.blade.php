    @extends('layouts.app')
    @if($purchase_type == "quotation")
    @section('title', __('Add Quotation'))
    @elseif($purchase_type == "gate_inward")
    @section('title', __('Gate In-Ward Pass'))
    @elseif($purchase_type == "add_grn")
    @section('title', __('Good Receiving Notes'))
    @else
    ...
    <section class="content-header">
    	@if($purchase_type == "quotation")
    		<h1>Add Quotation Purchase Order <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('purchase.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h1>
    	@elseif($purchase_type == "gate_inward" )
    		<h1>@lang('Add Gate In-word Pass') <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('purchase.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h1>
    		@elseif($purchase_type == "add_grn" )
    		<h1>@lang('ADD GRN') <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('purchase.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h1>
    	@else
    ...
    @if($purchase_type == "add_grn")
        {!! Form::open(['url' => action([\App\Http\Controllers\PurchaseOrderController::class, 'store_grn']), 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]) !!}
    @elseif($purchase_type == "quotation" || $purchase_type == "gate_inward")
    ...
    @else
    	{!! Form::open(['url' => action([\App\Http\Controllers\PurchaseOrderController::class, 'store_purchase_order']), 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]) !!}
    @endif	
    	@component('components.widget', ['class' => 'box-solid'])
    		...
    		<div class="row">
    			...
    			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
    				<div class="form-group">
    					@if($purchase_type == "quotation")
    					{!! Form::label('transaction_date', __('Quotation Date') . ':*') !!}
    					@elseif($purchase_type == "gate_inward")
    					{!! Form::label('transaction_date', __('Gate In Date') . ':*') !!}
    					@elseif($purchase_type == "add_grn")
    					{!! Form::label('transaction_date', __('GRN Date') . ':*') !!}
    					@else
    			...
    			@if($purchase_type == "gate_inward" || $purchase_type == "add_grn")
    			@else
    			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
    				<div class="form-group">
    	...
    	@component('components.widget', ['class' => 'box-solid'])
    		...
    		<div class="row @if( $purchase_type == "gate_inward") hide @endif">			
    			...
    			<table class="table">
    				...
    				<tr>
    					<td colspan="4">
    						<div class="form-group">
    						@if($purchase_type == "add_grn")
    						{!! Form::label('additional_notes',__('Goods Receiving Notes')) !!}
    						@elseif($purchase_type == "gate_inward")
    						{!! Form::label('additional_notes',__('Vehicle Details')) !!}
    						@else
