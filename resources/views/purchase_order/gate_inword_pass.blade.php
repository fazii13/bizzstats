...
<section class="content no-print">
    ...
    @endcomponent
    @component('components.widget', ['class' => 'box-primary', 'title' => __('All Gate In-Word Passes')])
...
<script type="text/javascript">
    $(document).ready( function(){
        ...
        purchase_order_table = $('#purchase_order_table').DataTable({
            ...
            scrollCollapse: true,
            ajax: {
                url: '{{action([\App\Http\Controllers\PurchaseOrderController::class, 'gate_inward_pass'])}}',
                data: function(d) {
