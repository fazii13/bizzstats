...
<section class="content-header no-print">
    <h1>@lang('Good Receiving Notes List')
    </h1>
</section>
...
<section class="content no-print">
    ...
    @endcomponent
    @component('components.widget', ['class' => 'box-primary', 'title' => __('All Good Receiving Notes List')])
        @can('purchase_order.create')
            @slot('tool')
                <div class="box-tools">
                    <a class="btn btn-block btn-primary" href="/purchase-order/create?status_purchase=gate_inward">
...
<script type="text/javascript">
    $(document).ready( function(){
        ...
        purchase_order_table = $('#purchase_order_table').DataTable({
            ...
            scrollCollapse: true,
            ajax: {
                url: '{{action([\App\Http\Controllers\PurchaseOrderController::class, 'grn_list'])}}',
                data: function(d) {
