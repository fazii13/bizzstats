...
<section class="content no-print">
    ...
    @endcomponent
    @component('components.widget', ['class' => 'box-primary', 'title' => __('All Quotation List')])
        @can('purchase_order.create')
            @slot('tool')
                <div class="box-tools">
                    <a class="btn btn-block btn-primary" href="/purchase-order/create?status_purchase=quotation">
...
<script type="text/javascript">
    $(document).ready( function(){
        ...
        purchase_order_table = $('#purchase_order_table').DataTable({
            ...
            scrollCollapse: true,
            ajax: {
                url: '{{action([\App\Http\Controllers\PurchaseOrderController::class, 'quotation_list'])}}',
                data: function(d) {
