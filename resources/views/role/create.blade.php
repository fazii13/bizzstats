            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'producation.view', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.producation_view') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'producation.create', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.producation_add') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'producation.update', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.producation_edit') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'producation.delete', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.producation_delete') }}
                            </label>
                        </div>
                    </div>
                </div>
