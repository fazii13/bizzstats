...
@section('content')
    ...
    <section class="content">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            ...
            <div class="row check_group">
                <div class="col-md-1">
                    <h4>@lang('lang_v1.producation')</h4>
                </div>
                <div class="col-md-2">
                    <div class="checkbox">
                        <label>
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'producation.view', in_array('producation.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('lang_v1.producation_view') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'producation.create', in_array('producation.create', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('lang_v1.producation_add') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'producation.update', in_array('producation.update', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('lang_v1.producation_edit') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'producation.delete', in_array('producation.delete', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('lang_v1.producation_delete') }}
                            </label>
                        </div>
                    </div>
                </div>
