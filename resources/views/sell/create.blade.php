...
@php
	...
	if($sale_type2 == "gate_outward")
	{
	    $title = ('Sale OutWard Pass');
	}
	if($sale_type2 == "add_gdn")
	{
	    $title = ('Add Good Delivery Notes');
	}
@endphp
...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
    @if($sale_type2 == 'add_gdn')
    {!! Form::open(['url' => action([\App\Http\Controllers\SellPosController::class, 'add_grn']), 'method' => 'post', 'id' => 'add_sell_form', 'files' => true ]) !!}
    @else
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid'])
				...
				<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
					<div class="form-group">
						@if($sale_type2 == "quotation")
						{!! Form::label('transaction_date', __('Quotation Date') . ':*') !!}
						@elseif($sale_type2 == "gate_outward")
						{!! Form::label('transaction_date', __('GateOutward Date') . ':*') !!}
						@elseif($sale_type2 == "add_gdn")
						{!! Form::label('transaction_date', __('GDN Date') . ':*') !!}
						@else
				...
				@if($sale_type != 'sales_order')
					<div class="col-sm-3">
						<div class="form-group">
							@if($sale_type2 == "quotation")
								{!! Form::label('invoice_scheme_id', __('Quotation Scheme') . ':') !!}
							@else
				...
				@endif
					...
					<div class="col-sm-3">
						<div class="form-group">
						@if($sale_type2 == "quotation")
						    {!! Form::label('invoice_no', $sale_type == 'sales_order' ? __('restaurant.order_no') : __('Quotation No') . ':') !!}
						@else
							{!! Form::label('invoice_no', $sale_type == 'sales_order' ? __('restaurant.order_no') : __('sale.invoice_no') . ':') !!}
						@endif
							{!! Form::text('invoice_no', null, [ 'class' => 'form-control ' . ($sale_type == 'sales_order' ? 'order-class' : 'invoice-class') ]) !!}
			...
			@component('components.widget', ['class' => 'box-solid']) 
				<div class="col-sm-10 col-sm-offset-1 @if( $sale_type2 == 'gate_outward' ) hide @endif">
					<div class="form-group">
						<div class="input-group">
				...
				<div class="row col-sm-12 pos_product_div @if( $sale_type2 == 'gate_outward' ) hide @endif" style="min-height: 0">
			...
			@endcomponent
			@component('components.widget', ['class' => 'box-solid'])
				<div class="col-md-4  @if($sale_type == 'sales_order' || $sale_type2 == 'gate_outward' || $sale_type2 == 'add_gdn') hide @endif">
			        <div class="form-group">
			    ...
			    <div class="col-md-4 @if($sale_type == 'sales_order'|| $sale_type2 == 'gate_outward' || $sale_type2 == 'add_gdn') hide @endif"><br>
			    ...
			    <div class="col-md-4 col-md-offset-4  @if($sale_type == 'sales_order' || $sale_type2 == 'gate_outward' || $sale_type2 == 'add_gdn') hide @endif">
			    ...
			    <div class="col-md-12">
			    	<div class="form-group">
			    	    @if($sale_type2 == 'gate_outward') 
			    	        {!! Form::label('sell_note',__('Vehicle Details')) !!}
			    	    @else
			...
			@endcomponent
			@component('components.widget', ['class' => 'box-solid'])
			@if($sale_type2 == 'gate_outward' || $sale_type2 == 'add_gdn')
	...
	@if((empty($status) || (!in_array($status, ['quotation', 'draft'])) || $is_enabled_download_pdf) && $sale_type != 'sales_order')
		@can('sell.payments')
			...
			@if($sale_type2 == 'gate_outward' || $sale_type2 == 'add_gdn')
				<div class="payment_row" @if($is_enabled_download_pdf) id="payment_rows_div" @endif hidden>
			@else
