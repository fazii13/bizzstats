...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::resource('producations', RecipeController::class);
    Route::get('/get-product-details/{id}', [RecipeController::class, 'getProductDetails']);Route::get('/toggle-subscription/{id}', 'SellPosController@toggleRecurringInvoices');
    ...
    Route::get('/sells/draft-gate-outward', [SellController::class, 'getGateOutwardDatables']);
    Route::get('/draft-gdn-outward', [SellController::class, 'getGdnDatables']);
    ...
    Route::post('store-grn-data', [SellPosController::class , 'add_grn'])->name('StoreGRN');
    ...
    Route::get('/quotation-list', [PurchaseOrderController::class, 'quotation_list'])->name('quotation.list');
    Route::get('/gate-inward-pass', [PurchaseOrderController::class, 'gate_inward_pass']);
    Route::get('/grn_list', [PurchaseOrderController::class, 'grn_list']);
    Route::get('/gate-outward-pass', [SellController::class, 'gate_outward_pass']);
     Route::get('/gdn-list', [SellController::class, 'gdn_list']);
        // Route::get('/gateoutwardpass', 'SellController@gateoutward');
    Route::post('store_grn', [PurchaseOrderController::class, 'store_grn']);
    Route::post('store_purchase_order', [PurchaseOrderController::class, 'store_purchase_order']);
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/purchases/print/{id}', [PurchaseController::class, 'printInvoice'])->name('purchasePrint.printInvoice');
...
Route::get('/sales-report-up', function () {
    $exitCode = Artisan::call('up');
    dd('Done'); 
});
Route::get('/sales-report-down', function () {
